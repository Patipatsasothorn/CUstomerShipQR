        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="https://webapp.bpi-concretepile.co.th:9021/">Home <span class="sr-only">(current)</span></a>
                </li>
            </ul>
        </div>
          <div class="mr-auto">
...
<h1>
  ...
  <div class="w3-Back" style="margin-top:0px" id="showcase">
    ...
    <h1 class="display-4">โปรแกรมยิงเข็มหน้าป้อม[UAT2]  </h1>
